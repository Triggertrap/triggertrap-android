...
public class TTApp {
	...
	public static final Boolean SHOW_DIALOG_AGAIN_DEFAULT = false;
	...
	private void init() {
		...
		ICO_MOON = Typeface.createFromAsset(mAppContext.getAssets(),
				"fonts/icomoon.ttf");
	}
	...
	public void setDoNotShowDialogAgain(boolean showAgain) {
