...
public class TimeLapseFragment extends TimeFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mErrorIcon = (TextView) mRootView.findViewById(R.id.errorIcon);
		mErrorIcon.setTypeface(ICO_MOON);
	...
	private int getErrorX() {
		...
		errorX = mErrorIcon.getWidth() - mErrorPopup.getWidth()
				- mErrorIcon.getPaddingRight() + offset;
	...
	private int getErrorY() {
		 ...
		 * height is smaller.
		 */
		final int compoundPaddingTop = mErrorIcon.getCompoundPaddingTop();
		int vspace = mErrorIcon.getBottom() - mErrorIcon.getTop()
				- mErrorIcon.getCompoundPaddingBottom() - compoundPaddingTop;

		int height = 0;

		int icontop = (int) (compoundPaddingTop + (vspace - height) / 1.5f);
		 ...
		 */
		final float scale = mErrorIcon.getResources().getDisplayMetrics().density;
		return icontop + height - mErrorIcon.getHeight()
				- (int) (2 * scale + 0.5f);
	}
