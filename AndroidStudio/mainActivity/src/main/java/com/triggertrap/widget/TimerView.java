...
public class TimerView extends LinearLayout implements DialPadInput {
    ...
    public void toggleDisplayMode(int m) {

        if (m == TimerView.LONG_TIME) {
            //show all

        } else if (m == TimerView.SHORT_TIME) {
            //Hide mins and secs
            mMinutesOnes.setVisibility(View.GONE);
            mMinutesTens.setVisibility(View.GONE);
            mMilliSeconds.setVisibility(View.GONE);
            mSeconds.setVisibility(View.GONE);
        }
