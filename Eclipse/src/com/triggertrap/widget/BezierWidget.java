...
//		Log.d(TAG, "Max Width: " + maxWidth + " MaxHeight: " + maxHeight);
//		Log.d(TAG, "Padding Left: " + paddingLeft + " padding Right:" + paddingRight +" padding Top:" + paddingTop + " padding Bottom:" + paddingBottom);
//				
...
//		//Transform the touch points 
//		xPos = xPos + mTranslateXOffset + mInnerFramePadding;
//		yPos = yPos +   mTranslateYOffset +mInnerFramePadding;
